...
namespace MY_WEB_APPLICATION.Areas.Cms.Controllers
{
    public partial class PostController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PostController Actions { get { return MVC.Cms.Post; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Cms/Views/Post/Create.cshtml";
            public readonly string Delete = "~/Areas/Cms/Views/Post/Delete.cshtml";
            public readonly string Details = "~/Areas/Cms/Views/Post/Details.cshtml";
            public readonly string Edit = "~/Areas/Cms/Views/Post/Edit.cshtml";
            public readonly string Index = "~/Areas/Cms/Views/Post/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PostController : MY_WEB_APPLICATION.Areas.Cms.Controllers.PostController
    {
        ...
        [NonAction]
        partial void GetPostsOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        [NonAction]
        public override System.Web.Mvc.JsonResult GetPosts()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetPosts);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.Cms.Post post);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Models.Cms.Post post)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "post", post);
            CreateOverride(callInfo, post);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.Cms.Post post);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Models.Cms.Post post)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "post", post);

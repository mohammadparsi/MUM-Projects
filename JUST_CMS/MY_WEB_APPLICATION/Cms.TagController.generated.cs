...
namespace MY_WEB_APPLICATION.Areas.Cms.Controllers
{
    public partial class TagController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TagController Actions { get { return MVC.Cms.Tag; } }
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _Partial_DisplayPages = "_Partial_DisplayPages";
                public readonly string Create = "Create";
                public readonly string Delete = "Delete";
                public readonly string Details = "Details";
                public readonly string Edit = "Edit";
            ...
            public readonly string _Partial_DisplayPages = "~/Areas/Cms/Views/Tag/_Partial_DisplayPages.cshtml";
            public readonly string Create = "~/Areas/Cms/Views/Tag/Create.cshtml";
            public readonly string Delete = "~/Areas/Cms/Views/Tag/Delete.cshtml";
            public readonly string Details = "~/Areas/Cms/Views/Tag/Details.cshtml";
            public readonly string Edit = "~/Areas/Cms/Views/Tag/Edit.cshtml";
            public readonly string Index = "~/Areas/Cms/Views/Tag/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TagController : MY_WEB_APPLICATION.Areas.Cms.Controllers.TagController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.Cms.Tag tag);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Models.Cms.Tag tag)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "tag", tag);
            CreateOverride(callInfo, tag);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.Cms.Tag tag);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Models.Cms.Tag tag)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "tag", tag);
            EditOverride(callInfo, tag);
            return callInfo;
        }

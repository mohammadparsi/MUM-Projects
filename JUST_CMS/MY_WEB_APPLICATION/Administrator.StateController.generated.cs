...
namespace MY_WEB_APPLICATION.Areas.Administrator.Controllers
{
    public partial class StateController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public StateController Actions { get { return MVC.Administrator.State; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Administrator/Views/State/Create.cshtml";
            public readonly string Delete = "~/Areas/Administrator/Views/State/Delete.cshtml";
            public readonly string Details = "~/Areas/Administrator/Views/State/Details.cshtml";
            public readonly string Edit = "~/Areas/Administrator/Views/State/Edit.cshtml";
            public readonly string Index = "~/Areas/Administrator/Views/State/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_StateController : MY_WEB_APPLICATION.Areas.Administrator.Controllers.StateController
    {
        public T4MVC_StateController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid? countryId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(System.Guid? countryId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "countryId", countryId);
            IndexOverride(callInfo, countryId);
            return callInfo;
        }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid? countryId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(System.Guid? countryId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "countryId", countryId);
            CreateOverride(callInfo, countryId);
            return callInfo;
        }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.State state);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Models.State state)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "state", state);
            CreateOverride(callInfo, state);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.State state);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Models.State state)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "state", state);
            EditOverride(callInfo, state);
            return callInfo;
        }

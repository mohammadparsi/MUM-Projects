...
namespace MY_WEB_APPLICATION.Areas.Administrator.Controllers
{
    public partial class CityController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CityController Actions { get { return MVC.Administrator.City; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Administrator/Views/City/Create.cshtml";
            public readonly string Delete = "~/Areas/Administrator/Views/City/Delete.cshtml";
            public readonly string Details = "~/Areas/Administrator/Views/City/Details.cshtml";
            public readonly string Edit = "~/Areas/Administrator/Views/City/Edit.cshtml";
            public readonly string Index = "~/Areas/Administrator/Views/City/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CityController : MY_WEB_APPLICATION.Areas.Administrator.Controllers.CityController
    {
        public T4MVC_CityController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid? stateId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(System.Guid? stateId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "stateId", stateId);
            IndexOverride(callInfo, stateId);
            return callInfo;
        }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid? stateId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(System.Guid? stateId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "stateId", stateId);
            CreateOverride(callInfo, stateId);
            return callInfo;
        }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.City city);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Models.City city)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.City city);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Models.City city)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "city", city);

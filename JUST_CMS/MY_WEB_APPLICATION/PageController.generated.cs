...
namespace MY_WEB_APPLICATION.Controllers
{
    public partial class PageController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Views/Page/Display.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PageController : MY_WEB_APPLICATION.Controllers.PageController
    {
        public T4MVC_PageController() : base(Dummy.Instance) { }

        [NonAction]
        partial void DisplayOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string name);

        [NonAction]
        public override System.Web.Mvc.ActionResult Display(string name)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Display);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "name", name);
            DisplayOverride(callInfo, name);
            return callInfo;
        }

...
namespace MvcEshop.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : MvcEshop.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.ViewModels.Account.EditViewModel editViewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MvcEshop.ViewModels.Account.EditViewModel editViewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);

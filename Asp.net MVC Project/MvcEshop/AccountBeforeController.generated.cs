...
{
    public partial class AccountBeforeController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AccountBeforeController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AccountBeforeController Actions { get { return MVC.AccountBefore; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "AccountBefore";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "AccountBefore";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _ChangePasswordPartial = "~/Views/AccountBefore/_ChangePasswordPartial.cshtml";
            public readonly string _ExternalLoginsListPartial = "~/Views/AccountBefore/_ExternalLoginsListPartial.cshtml";
            public readonly string _RemoveAccountPartial = "~/Views/AccountBefore/_RemoveAccountPartial.cshtml";
            public readonly string _SetPasswordPartial = "~/Views/AccountBefore/_SetPasswordPartial.cshtml";
            public readonly string ConfirmEmail = "~/Views/AccountBefore/ConfirmEmail.cshtml";
            public readonly string ExternalLoginConfirmation = "~/Views/AccountBefore/ExternalLoginConfirmation.cshtml";
            public readonly string ExternalLoginFailure = "~/Views/AccountBefore/ExternalLoginFailure.cshtml";
            public readonly string ForgotPassword = "~/Views/AccountBefore/ForgotPassword.cshtml";
            public readonly string ForgotPasswordConfirmation = "~/Views/AccountBefore/ForgotPasswordConfirmation.cshtml";
            public readonly string Login = "~/Views/AccountBefore/Login.cshtml";
            public readonly string Manage = "~/Views/AccountBefore/Manage.cshtml";
            public readonly string Register = "~/Views/AccountBefore/Register.cshtml";
            public readonly string ResetPassword = "~/Views/AccountBefore/ResetPassword.cshtml";
            public readonly string ResetPasswordConfirmation = "~/Views/AccountBefore/ResetPasswordConfirmation.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountBeforeController : MvcEshop.Controllers.AccountBeforeController
    {
        public T4MVC_AccountBeforeController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.LoginViewModel model, string returnUrl);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(MvcEshop.Models.LoginViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.Users model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Register(MvcEshop.Models.Users model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ForgotPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.ForgotPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ForgotPassword(MvcEshop.Models.ForgotPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ForgotPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ResetPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.ResetPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ResetPassword(MvcEshop.Models.ResetPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ResetPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Controllers.AccountBeforeController.ManageMessageId? message);

        [NonAction]
        public override System.Web.Mvc.ActionResult Manage(MvcEshop.Controllers.AccountBeforeController.ManageMessageId? message)
        {
        ...
        [NonAction]
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.ManageUserViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Manage(MvcEshop.Models.ManageUserViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.ExternalLoginConfirmationViewModel model, string returnUrl);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ExternalLoginConfirmation(MvcEshop.Models.ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ExternalLoginConfirmation);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "returnUrl", returnUrl);

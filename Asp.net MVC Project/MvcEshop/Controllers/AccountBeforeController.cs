...
{
    [Authorize]
    public partial class AccountBeforeController : Controller
    {
        private ApplicationUserManager _userManager;

        public AccountBeforeController()
        {
        }

        public AccountBeforeController(ApplicationUserManager userManager)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public virtual ActionResult Register(Users model)
        {
            if (ModelState.IsValid)
            {
                ...
                model.RoleID = 2;
                model.ActiveCode = Guid.NewGuid().ToString().Replace("-", "");
                db.Users.Add(model);
                db.SaveChanges();

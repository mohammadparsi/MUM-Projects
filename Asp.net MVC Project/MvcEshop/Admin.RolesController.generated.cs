...
namespace MvcEshop.Areas.Admin.Controllers
{
    public partial class RolesController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Delete = "~/Areas/Admin/Views/Roles/Delete.cshtml";
            public readonly string Details = "~/Areas/Admin/Views/Roles/Details.cshtml";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_RolesController : MvcEshop.Areas.Admin.Controllers.RolesController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.Roles roles);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(MvcEshop.Models.Roles roles)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "roles", roles);
            CreateOverride(callInfo, roles);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.Roles roles);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MvcEshop.Models.Roles roles)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "roles", roles);
            EditOverride(callInfo, roles);
            return callInfo;
        }

...
namespace MvcEshop.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UsersController : MvcEshop.Areas.Admin.Controllers.UsersController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.Users users);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(MvcEshop.Models.Users users)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "users", users);
            CreateOverride(callInfo, users);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.Users users);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MvcEshop.Models.Users users)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "users", users);
            EditOverride(callInfo, users);
            return callInfo;
        }

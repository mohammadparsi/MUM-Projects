...
namespace MvcEshop.Controllers
{
    public partial class ContractController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ContractController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ContractController Actions { get { return MVC.Contract; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Contract";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Contract";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Contract/Create.cshtml";
            public readonly string Delete = "~/Views/Contract/Delete.cshtml";
            public readonly string Edit = "~/Views/Contract/Edit.cshtml";
            public readonly string Index = "~/Views/Contract/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ContractController : MvcEshop.Controllers.ContractController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.ViewModels.Contract.CreateViewModel createViewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(MvcEshop.ViewModels.Contract.CreateViewModel createViewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.ViewModels.Contract.CreateViewModel createViewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MvcEshop.ViewModels.Contract.CreateViewModel createViewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "createViewModel", createViewModel);

...
namespace MvcEshop.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SettingsController : MvcEshop.Controllers.SettingsController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.Models.Setting setting);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MvcEshop.Models.Setting setting)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);

...
namespace MvcEshop.Controllers
{
    public partial class ClassController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Class/Create.cshtml";
            public readonly string Delete = "~/Views/Class/Delete.cshtml";
            public readonly string Edit = "~/Views/Class/Edit.cshtml";
            public readonly string Index = "~/Views/Class/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ClassController : MvcEshop.Controllers.ClassController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.ViewModels.Class.CreateViewModel createViewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(MvcEshop.ViewModels.Class.CreateViewModel createViewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcEshop.ViewModels.Class.CreateViewModel editViewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MvcEshop.ViewModels.Class.CreateViewModel editViewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
